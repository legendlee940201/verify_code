...
<title>手机验证码</title>
<script src="/verifi_code/static/jquery/jquery-3.1.0.js"></script>
<link href="/verifi_code/static/bs/css/bootstrap.min.css"
	rel="stylesheet" />
<script src="/verifi_code/static/bs/js/bootstrap.min.js"></script>
	...
	$(function() {
		$("#sendCode").click(
				function() {
					...
					$.post("/verifi_code/CodeSenderServlet", $("#codeform")
		...
		$("#verifyCode").click(
				function() {
					...
					$.post("/verifi_code/CodeVerifyServlet", $("#codeform")
							.serialize(), function(data) {
						if (data == "true") {
